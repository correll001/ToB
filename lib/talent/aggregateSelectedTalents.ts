...
function scaleStatBlock(b: StatBlock, rank: number): StatBlock {
  ...
  if (b.spellDamagePct != null) o.spellDamagePct = mul(b.spellDamagePct)
  if (b.attackDamagePct != null) o.attackDamagePct = mul(b.attackDamagePct)
  if (b.meleeDamagePct != null) o.meleeDamagePct = mul(b.meleeDamagePct)
  if (b.projectileDamagePct != null) o.projectileDamagePct = mul(b.projectileDamagePct)
  if (b.physicalDamagePct != null) o.physicalDamagePct = mul(b.physicalDamagePct)
  if (b.erosionDamagePct != null) o.erosionDamagePct = mul(b.erosionDamagePct)
  if (b.fireDamagePct != null) o.fireDamagePct = mul(b.fireDamagePct)
  if (b.lightningDamagePct != null) o.lightningDamagePct = mul(b.lightningDamagePct)
  if (b.coldDamagePct != null) o.coldDamagePct = mul(b.coldDamagePct)
  if (b.elementalDamagePct != null) o.elementalDamagePct = mul(b.elementalDamagePct)
  if (b.dotDamagePct != null) o.dotDamagePct = mul(b.dotDamagePct)
  if (b.minionDamagePct != null) o.minionDamagePct = mul(b.minionDamagePct)
  if (b.minionFireDamagePct != null) o.minionFireDamagePct = mul(b.minionFireDamagePct)
  if (b.minionLightningDamagePct != null) o.minionLightningDamagePct = mul(b.minionLightningDamagePct)
  if (b.minionColdDamagePct != null) o.minionColdDamagePct = mul(b.minionColdDamagePct)
  if (b.minionErosionDamagePct != null) o.minionErosionDamagePct = mul(b.minionErosionDamagePct)
  if (b.minionPhysicalDamagePct != null) o.minionPhysicalDamagePct = mul(b.minionPhysicalDamagePct)
  if (b.channeledDamagePct != null) o.channeledDamagePct = mul(b.channeledDamagePct)
  ...
  if (b.coldResistancePct != null) o.coldResistancePct = mul(b.coldResistancePct)
  if (b.fireResistancePct != null) o.fireResistancePct = mul(b.fireResistancePct)
  if (b.lightningResistancePct != null) o.lightningResistancePct = mul(b.lightningResistancePct)
  if (b.erosionResistancePct != null) o.erosionResistancePct = mul(b.erosionResistancePct)
  if (b.elementalResistancePct != null) o.elementalResistancePct = mul(b.elementalResistancePct)
  if (b.skillCostFlat != null) o.skillCostFlat = mul(b.skillCostFlat)
